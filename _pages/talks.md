...
<div class="posts-layout">
  ...
  <div class="blog-entry" data-type="panel">
    <span class="blog-title">Women in AI/ML Infrastructure — Panelist, NVIDIA GTC (hosted by Modal)</span>
    <span class="blog-date">03.26</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://robogen-iros.github.io/" class="blog-title" target="_blank">Building toward Embodied AGI: Solving the Data Bottleneck — RoboGen Workshop General Chair, IEEE IROS</a>
    <span class="blog-date">10.25</span>
  </div>

  <div class="blog-entry" data-type="panel">
    <a href="https://ieeemobility.org/MOST2025/keynote.php" class="blog-title" target="_blank">Driving Force: Towards Large-Scale Autonomous Driving Commercialization — Panel Chair, IEEE MOST</a>
    <span class="blog-date">05.25</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://world.aiacceleratorinstitute.com/location/austin/" class="blog-title" target="_blank">Generative AI: A New World Simulator for Synthetic Data — Generative AI Summit, Austin</a>
    <span class="blog-date">2024</span>
  </div>

  <div class="blog-entry" data-type="panel">
    <a href="https://docs.google.com/presentation/d/1i6EZEfebDGI1I0zpZoV6OHZ5kWvmX3OZ/edit?usp=sharing&ouid=103941006958426062861&rtpof=true&sd=true" class="blog-title" target="_blank">Generative AI: A New World Simulator to Transform Data Generation at Large Scale — Workshop Moderator, Auto.AI</a>
    <span class="blog-date">2024</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://www.nvidia.com/en-us/on-demand/session/gtcspring23-s51407/" class="blog-title" target="_blank">Synthetic Data Generation for Autonomous Driving — Technical Keynote, NVIDIA GTC</a>
    <span class="blog-date">03.23</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://www.linkedin.com/pulse/from-lab-road-turning-self-driving-research-production-zhang/" class="blog-title" target="_blank">From Lab to Road: Turning Self-Driving Research into Production Features — Novel Sensor Workshop, IEEE IROS</a>
    <span class="blog-date">10.23</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://www.linkedin.com/feed/update/urn:li:activity:7135087893168934912/" class="blog-title" target="_blank">Continuous Learning Loop: Online / Offline Perception Systems — Seminar, University of Delaware</a>
    <span class="blog-date">11.23</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://www.aiacceleratorinstitute.com/computer-vision-summit-san-jose-april-2023-ai-accelerator-institute/" class="blog-title" target="_blank">Deep Learning-based Data-centric Solutions — Computer Vision Summit, San Jose</a>
    <span class="blog-date">04.23</span>
  </div>

  <div class="blog-entry" data-type="keynote">
    <a href="https://www.researchgate.net/publication/382000139_Data_misconceptions_challenges_and_solutions" class="blog-title" target="_blank">Data Misconceptions: Challenges and Solutions — AI Accelerator Summit</a>
