...
<div class="posts-layout">
  <nav class="posts-filter" aria-label="Section filter">
    ...
    <button class="filter-item" data-filter="service">Leadership</button>
  </nav>
...
<ul id="service-list">
  ...
  <li>
    ...
    General Chair for the RoboGen Workshop at the IEEE IROS 2025 Conference <a href="https://robogen-iros.github.io/">[Call for Papers]</a>
  </li>
  ...
  <li>
    <span class="service-title">Auto.AI Moderator</span><br>
