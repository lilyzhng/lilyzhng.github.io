...
<figure class="diagram bare"><svg viewbox="30 44 880 348" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="The model layer grows from the bottom over time, absorbing quantization, benchmarks and the speculator; the serving layer's remaining space shrinks until only serve is left.">
<path d="M 60 300 C 110.0 300 110.0 282 160 282 C 260.0 282 260.0 212 360 212 C 462.5 212 462.5 162 565 162 C 667.5 162 667.5 106 770 106 C 825.0 106 825.0 96 880 96  L 880 70 L 60 70 Z" fill="#8a8a84" fill-opacity="0.07"></path>
<path d="M 60 300 C 110.0 300 110.0 282 160 282 C 260.0 282 260.0 212 360 212 C 462.5 212 462.5 162 565 162 C 667.5 162 667.5 106 770 106 C 825.0 106 825.0 96 880 96  L 880 345 L 60 345 Z" fill="#1f5c3d" fill-opacity="0.08"></path>
<path d="M 60 300 C 110.0 300 110.0 282 160 282 C 260.0 282 260.0 212 360 212 C 462.5 212 462.5 162 565 162 C 667.5 162 667.5 106 770 106 C 825.0 106 825.0 96 880 96 " fill="none" stroke="#d6437c" stroke-width="2.4" stroke-dasharray="1 7" stroke-linecap="round"></path>
<line x1="60" y1="70" x2="880" y2="70" stroke="#c9c9c2" stroke-width="1.4"></line>
<text x="68" y="58" font-family="Inter,system-ui,sans-serif" font-size="13.5" font-weight="700" fill="#6b6b65">SERVING LAYER</text>
<text x="872" y="331" text-anchor="end" font-family="Inter,system-ui,sans-serif" font-size="13.5" font-weight="700" fill="#1f5c3d">MODEL LAYER</text><line x1="160" y1="70" x2="160" y2="273" stroke="#9a9a94" stroke-width="1.5"></line><text x="160" y="90" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#6b6b65">quantize · draft · serve</text><circle cx="160" cy="282" r="6.5" fill="#1f5c3d" stroke="#fff" stroke-width="2"></circle><text x="160" y="308" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="14.5" font-weight="600" fill="#1a1a19">DeepSeek-V3</text><text x="160" y="325" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="11.5" fill="#8a8a84">Dec 2024</text><text x="160" y="343" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#1f5c3d">fp8 @ pre-training</text><line x1="360" y1="70" x2="360" y2="203" stroke="#9a9a94" stroke-width="1.5"></line><text x="360" y="90" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#6b6b65">draft · serve</text><circle cx="360" cy="212" r="6.5" fill="#1f5c3d" stroke="#fff" stroke-width="2"></circle><text x="360" y="238" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="14.5" font-weight="600" fill="#1a1a19">gpt-oss</text><text x="360" y="255" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="11.5" fill="#8a8a84">Aug 2025</text><text x="360" y="273" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#1f5c3d">mxfp4 QAT</text><line x1="565" y1="70" x2="565" y2="153" stroke="#9a9a94" stroke-width="1.5"></line><text x="565" y="90" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#6b6b65">draft · serve</text><circle cx="565" cy="162" r="6.5" fill="#1f5c3d" stroke="#fff" stroke-width="2"></circle><text x="565" y="188" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="14.5" font-weight="600" fill="#1a1a19">K2-Thinking</text><text x="565" y="205" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="11.5" fill="#8a8a84">Nov 2025</text><text x="565" y="223" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#1f5c3d">benchmarks @ int4</text><line x1="770" y1="70" x2="770" y2="97" stroke="#9a9a94" stroke-width="1.5"></line><text x="770" y="90" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#6b6b65">serve</text><circle cx="770" cy="106" r="6.5" fill="#1f5c3d" stroke="#fff" stroke-width="2"></circle><text x="770" y="132" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="14.5" font-weight="600" fill="#1a1a19">Kimi K3</text><text x="770" y="149" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="11.5" fill="#8a8a84">Jul 2026</text><text x="770" y="167" text-anchor="middle" font-family="ui-monospace,'SF Mono',Menlo,monospace" font-size="11.5" fill="#1f5c3d">speculator ships too</text><line x1="60" y1="363" x2="880" y2="363" stroke="#e7e7e2" stroke-width="1"></line><text x="330" y="383" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="12" fill="#8a8a84">2025</text><text x="720" y="383" text-anchor="middle" font-family="Inter,system-ui,sans-serif" font-size="12" fill="#8a8a84">2026</text></svg><figcaption>Figure 6. The model layer absorbs acceleration step by step. The room left for serving shrinks toward one job: serve.</figcaption></figure>
