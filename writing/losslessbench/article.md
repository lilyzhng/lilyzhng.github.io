...
Speculative decoding is lossless in theory: the verified output follows the target model's distribution. The papers, including <a href="https://arxiv.org/abs/2503.01840" style="color:#2a5a8a;text-decoration:underline;text-decoration-color:#2a5a8a;">EAGLE-3</a>, <a href="https://arxiv.org/abs/2602.06036" style="color:#2a5a8a;text-decoration:underline;text-decoration-color:#2a5a8a;">DFlash</a>, <a href="https://arxiv.org/abs/2607.05147" style="color:#2a5a8a;text-decoration:underline;text-decoration-color:#2a5a8a;">DeepSeek DSpark</a>, and <a href="https://inco.ai/blog/dflash2/" style="color:#2a5a8a;text-decoration:underline;text-decoration-color:#2a5a8a;">DFlash 2</a>, only validate on easy-to-measure domains such as math and function-level coding, a narrow slice of what models are asked to do in practice. To measure speculative decoding and inference acceleration on domains beyond coding and math, we built LosslessBench.
