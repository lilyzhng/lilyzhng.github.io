...
<div class="intro-flex">
  ...
  <div class="intro-text">
    ...
    <p>
      At <a href="https://lat.ai/" target="_blank" rel="noopener">Latitude AI</a>, I am building the data flywheel for autonomy: turning raw messy data into a continuous learning system (VLM-based retrieval and curation, efficient auto-labeling, and data generation at large scale).
